        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-8 -right-8 bg-gold p-6 shadow-lg hidden md:block">
                <p className="font-playfair text-4xl text-white">15+</p>
                <p className="text-sm text-white/90 uppercase tracking-wider">Years of Excellence</p>
              </div>
            </div>
          </div>
