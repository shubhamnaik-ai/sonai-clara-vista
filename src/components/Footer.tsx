      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#sonai-clara" className="text-white/70 hover:text-gold transition-colors">Sonai Clara</a>
              </li>
              <li>
                <a href="#amenities" className="text-white/70 hover:text-gold transition-colors">Amenities</a>
              </li>
              <li>
                <a href="#floor-plans" className="text-white/70 hover:text-gold transition-colors">Floor Plans</a>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-white/50 text-sm hover:text-gold transition-colors">Privacy Policy</a>
            <a href="#" className="text-white/50 text-sm hover:text-gold transition-colors">Terms of Service</a>
            <a href="#" className="text-white/50 text-sm hover:text-gold transition-colors">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
